...
export default function BackToTopButton() {
  ...
  return (
    <button
      ...
      className={`fixed bottom-6 right-6 z-40 rounded-full border border-line/10 bg-surface p-3 text-brand-teal shadow-lg shadow-black/20 transition-[opacity,transform] duration-200 hover:bg-surface-hover ${
