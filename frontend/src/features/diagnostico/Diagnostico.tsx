        ...
        {stepIndex === -1 && (
          <motion.div key="start" {...transition} className="mt-4 flex flex-col gap-5">
            ...
            <button
              ...
              className="group inline-flex w-fit items-center gap-2 rounded-full bg-gradient-to-r from-brand-green to-brand-teal px-6 py-3 text-sm font-semibold text-navy-950 transition-transform hover:scale-[1.03] motion-reduce:transform-none"
            >
              {diagnosis.start}
          ...
          <motion.div key="result" {...transition} className="mt-4 flex flex-col gap-5">
            ...
            <div className="flex flex-wrap gap-3">
              <button
                ...
                className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-brand-green to-brand-teal px-6 py-3 text-sm font-semibold text-navy-950 transition-transform hover:scale-[1.03] motion-reduce:transform-none"
              >
                {diagnosis.toForm}
                <ArrowRight size={16} aria-hidden="true" className="transition-transform group-hover:translate-x-0.5" />
              </button>
